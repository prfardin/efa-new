...
export default async function compile() {
    ...
    const lessFile = readFileSync('resources/back-office/src/less/default-rtl.less', 'utf8');
    ...
    const css = await less.render(lessFile, {
        ...
        paths: ['resources/back-office/src/less/'],
    });

    // at this time we save compiled less in cache folder
    ...
    postcss()
        ...
        .process(css.css)
        .then((result: any) => fs.writeFileSync('resources/back-office/src/cache/default-rtl.less', result.css));
}
