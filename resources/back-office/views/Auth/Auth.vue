            ...
            <div class="uk-width-1-1">
                <div uk-height-viewport="expand: true" class="uk-grid-collapse uk-grid-item-match" uk-grid>
                    <div class="uk-width-1-3" style="position: relative; width: 310px;overflow: hidden">
                        ...
                        <div v-if="rippleSet" class="uk-height-1-1 uk-tile uk-tile-primary uk-tile-large uk-flex uk-flex-top" style="overflow: hidden; background-color: #fff; padding-top: 115px">
                            <div class="uk-width-1-1" uk-scrollspy="target: > div; cls: uk-animation-fade; delay: 75">
                                <div style="margin-bottom: 22px; display: flex; align-items: center;">
                                    <span style="box-sizing: border-box;background-color: #0fc96f; border: 1px solid #0fc96f; border-radius: 100%; margin-right: 14px; display: flex; width: 22px; height: 22px; font-size: 12px; font-weight: 900; align-items: center;justify-content: center" uk-icon="icon: check;ratio: 0.8"></span>
                                    <span style="font-size: 14px; color: #d6dcdf">Register</span>
                                </div>
                                <div style="margin-bottom: 22px; display: flex; align-items: center;">
                                    <span style="box-sizing: border-box;border-radius: 100%; margin-right: 14px; border: 1px solid #1c56ba; color:#1c56ba; width: 22px; height: 22px; font-size: 12px; font-weight: 900; display: flex; align-items: center;justify-content: center;">2</span>
                                    <span style="font-size: 14px; color: #1c56ba; font-weight: 700">State</span>
                                    <span class="uk-width-expand uk-text-right" style="font-size: 14px; color: #d4d8e3; font-weight: 700" uk-icon="line-arrow-right"></span>
                                </div>
                                <div style="margin-bottom: 22px; display: flex; align-items: center;">
                                    <span style="box-sizing: border-box;border-radius: 100%; margin-right: 14px; border: 1px solid #e0e2e2; color:#85868f; width: 22px; height: 22px; font-size: 12px; display: flex; align-items: center;justify-content: center; font-weight: 700">3</span>
                                    <span style="font-size: 14px; color: #85868f; font-weight: 700">Business Details</span>
                                </div>
                                <div style="margin-bottom: 22px; display: flex; align-items: center;">
                                    <span style="box-sizing: border-box;border-radius: 100%; margin-right: 14px; border: 1px solid #e0e2e2; color:#85868f; width: 22px; height: 22px; font-size: 12px; display: flex; align-items: center;justify-content: center; font-weight: 700">4</span>
                                    <span style="font-size: 14px; color: #85868f; font-weight: 700">Team</span>
                                </div>
                                <div style="margin-bottom: 22px; display: flex; align-items: center;">
                                    <span style="box-sizing: border-box;border-radius: 100%; margin-right: 14px; border: 1px solid #e0e2e2; color:#85868f; width: 22px; height: 22px; font-size: 12px; display: flex; align-items: center;justify-content: center; font-weight: 700">5</span>
                                    <span style="font-size: 14px; color: #85868f; font-weight: 700">Personal Details</span>
                                </div>
                            </div>
                            <div  uk-scrollspy="target: > div; cls: uk-animation-fade; delay: 50">
                                <div style="position: absolute; bottom: -110px; left: -80px; background-color: #f5f8ff; width: 440px; height: 170px; transform: rotate(23deg);"></div>
                                <div style="position: absolute; bottom: -110px; left: -80px; background-color: #eaf0ff; width: 340px; height: 170px; transform: rotate(30deg);"></div>
                                <div style="position: absolute; bottom: 65px; left: 55px">
                        ...
                        <div v-if="!rippleSet" style="position: absolute; top: 32px; left: 38px; color: #fff">
                            ...
                            <span style="font-size: 14px; font-weight: 900; color: #87c0ff">Fullfill</span>
                        </div>
                        <div v-else style="position: absolute; top: 32px; left: 38px; color: #fff" uk-scrollspy="cls: uk-animation-fade">
                            ...
                            <span style="font-size: 14px; font-weight: bolder; color: #c2c4c9">Fullfill</span>
                        </div>
                    </div>
