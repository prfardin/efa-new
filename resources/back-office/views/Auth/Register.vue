            ...
            <div class="uk-margin-medium-top">
                <div class="uk-grid-small uk-flex-bottom" uk-grid>
                    <div class="uk-width-expand">
                        <label class="pr-auth-form-label uk-display-inline-block" for="mobile">{{ t('auth.register.mobile') }} <pr-icon class="pr-auth-form-helper" icon="question" ratio="0.5"></pr-icon></label>
                        <div class="pr-auth-form-group">
                            <div>
                            ...
                            <div>
                                <input autofocus v-model="mobile" class="uk-input input uk-form-small uk-text-left" id="mobile" name="mobile" type="text" style="direction: ltr; border-left: none; height: 36px; width: 210px">
                            </div>
                        </div>
                    </div>
                ...
                <label style="font-size: 12px; margin-top: 6px; display: inline-block">
                    <input checked class="input uk-checkbox" type="checkbox" value="">
