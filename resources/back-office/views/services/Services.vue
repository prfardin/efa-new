...
import PrList from '@bc/core/list.vue'
            ...
            <pr-container small>
                <pr-grid collapse match class="pr-auth-background-muted pr-auth-height">
                    <div class="pr-auth-side uk-width-1-3@m">
                        ...
                        <pr-tile class="pr-auth-tile pr-auth-tile-default pr-auth-background-default uk-flex uk-flex-top pr-auth-tile-has-list">
