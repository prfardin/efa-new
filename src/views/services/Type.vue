...
<template>
    <div class="uk-height-1-1 uk-tile uk-tile-default uk-flex uk-flex-left uk-flex-top" style="background-color: #f5f6f9; padding-top: 88px; padding-bottom: 10px">
        <div class="anim-in">
            <div>
                <h3 class="uk-h5" style="font-weight: 700; color: #464964; font-size: 20px; margin-bottom: 0">نوع کسب و کارت رو انتخاب کن</h3>
                            ...
                            <div class="uk-width-expand">
                                <div style="width: 310px;padding: 20px 25px; background-color: #edf4ff; border: 2px solid #576cb5; border-radius: 8px">
                                    <div class="uk-grid-small uk-flex-middle" uk-grid>
                                        ...
                                        <div>
                                            <h6 class="uk-margin-remove-bottom" style="margin-left:5px;font-weight: 700;">انبار داری</h6>
                                            <p class="uk-margin-remove-top" style="margin-left:5px;font-size: 13px;color: #868d9a; font-weight: 600; margin-top: 3px !important;">متعلق به E-Commerce</p>
                                        </div>
                                ...
                                <div style="margin-top: 12px;width: 310px;padding: 20px 25px; background-color: #fff; border: 2px solid transparent; border-radius: 8px">
                                    <div class="uk-grid-small uk-flex-middle" uk-grid>
                                        ...
                                        <div>
                                            <h6 class="uk-margin-remove-bottom" style="margin-left:5px;font-weight: 700;">بسته بندی</h6>
                                            <p class="uk-margin-remove-top" style="margin-left:5px;font-size: 13px;color: #868d9a; font-weight: 600; margin-top: 3px !important;">برای کسب و کار های کوچک</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
